...
<div
	class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 flex flex-col items-center p-4 sm:p-6 transition-colors duration-300"
>
	<div
		class="bg-white/80 dark:bg-slate-800/90 backdrop-blur-sm shadow-2xl rounded-2xl border border-white/20 dark:border-slate-700/50 p-6 sm:p-8 max-w-3xl w-full transition-all duration-300"
	>
		<!-- Header Section -->
		<div
		...
		>
			<div>
				<h1
					class="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent"
				>
			...
			<div
				class="flex items-center gap-3 bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-xl border border-red-200 dark:border-red-800"
			>
				<div
		...
		<div class="mb-8">
			...
			<div
				class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-3 shadow-inner"
			>
				<div
			...
			<div
				class="flex justify-between mt-2 text-xs text-slate-500 dark:text-slate-400"
			>
				<span>Started</span>
		...
		{#if currentQuestion}
			<!-- Question Section -->
			<div
				class="mb-8 p-6 border border-slate-200 dark:border-slate-600 rounded-2xl bg-gradient-to-r from-slate-50 to-white dark:from-slate-700 dark:to-slate-800 shadow-sm"
			>
				<div class="flex items-start gap-4">
					...
					<div class="flex-1">
						<h2
							class="text-xl sm:text-2xl font-semibold text-slate-800 dark:text-slate-100 mb-6 leading-relaxed"
							id="questionText"
						>
							{@html processLatexInText(
		...
		{:else if questions && questions.length === 0}
			...
			<div class="text-center py-12">
				...
				<p class="text-slate-600 dark:text-slate-400 mb-6">
					No questions could be loaded for this quiz. Please go back
					and try again.
				</p>
				<a
		...
		{:else}
			...
			<div class="text-center py-12">
				<div
					class="w-16 h-16 mx-auto mb-4 border-4 border-blue-200 dark:border-blue-800 border-t-blue-500 dark:border-t-blue-400 rounded-full animate-spin"
				></div>
				<h3
					class="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-2"
				>
